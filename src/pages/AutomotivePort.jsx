...
export default function AutomotivePort({ onNavigate, onAddToCart }) {
  const autoItems = [
    { id: 'au-1', title: 'Synthetic Engine Oil 5W-30 (4L)', price: '38,000', img: '🛢️', location: 'Lagos Hub' },
    { id: 'au-2', title: 'HD Smart DashCam 1080P Night Vision', price: '65,000', img: '📹', location: 'Lagos Hub' },
    { id: 'au-3', title: 'Heavy Duty Emergency Jump Starter Kit', price: '85,000', img: '🔋', location: 'Lagos Hub' }
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 text-white space-y-8">
      <div className="flex justify-between items-center border-b border-slate-800 pb-4">
        <div>
          <span className="text-[10px] font-black tracking-widest text-[#FF5A00] uppercase">Logistics & Spares</span>
          <h1 className="text-3xl font-black mt-1">Automotive Port</h1>
        </div>
